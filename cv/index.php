...
$path = '../uploads/thumb/'.$Setupdetails['Image']; 
$data = file_get_contents($path);
$posterlogo = 'data:image/' . pathinfo('pm-ujjwala.png', PATHINFO_EXTENSION) . ';base64,' . base64_encode(file_get_contents('pm-ujjwala.png'));
...
$dompdf->render();
$dompdf->stream($name."_".rand(10,1000).".pdf",array("Attachment" => false));
exit(0);
?>