<?php include("library.php");  if(!isset($_SESSION['bjpmember'])){ $COMMON->redirect('get-started'); }
$creationno = $_SESSION['bjpmember'];
$Setupdetails = $COMMON->givedata('certifications',$creationno);  
$membertype = $Setupdetails['Type']; 
if($_SESSION['bjpmember']!=$Setupdetails['Id'])
{
 	$COMMON->redirect('get-started');
} 
            ...
            <div class="mt-100">
              ...
              <div id="userimgmsg"></div>
                ...
                <div class="row align-items-center">
                  <div class="col-lg-10 col-9 col-md-8 mt-s">
                    <h6 class="">
                  ...
                  <div class="col-lg-2 col-3 col-md-4"> <img src="<?php echo ($Setupdetails['Image']!='')?'uploads/thumb/'.$Setupdetails['Image']:'img/test-img/user.jpg'; ?>" class="d-block" alt="" id="userimg"> </div>
                  
                </div>
                  <div class="row">
                  <div class="col-lg-6">
                      <label>Vidhan Sabha/Mandal:</label>
                      <input type="text" name="VidhanSabha" readonly value="<?php if(isset($Setupdetails)){if($Setupdetails['VidhanSabha']!=''){echo $Setupdetails['VidhanSabha'];} else { echo 'VidhanSabha';}} ?>" class="form-control">
                      
                    </div>
                    <div class="col-lg-6">
                      <label>Block</label>
                       <input type="text" name="Block" readonly value="<?php if(isset($Setupdetails)){if($Setupdetails['Block']!=''){echo $Setupdetails['Block'];} else { echo 'Block';}} ?>" class="form-control">
                    ...
                    <div class="col-lg-6">
                      ...
                      <select name="MemberType" class="form-control" required  >
                        ...
                        <option <?php if(isset($Setupdetails)) { if($Setupdetails['MemberType']!='') { if($Allmembertype[$i]['Heading']==$Setupdetails['MemberType']) echo 'selected'; }  }  ?>  ><?php echo $Allmembertype[$i]['Heading']; ?></option>
                        <?php }?>
                    ...
                    <div class="col-lg-6">
                      <label>DOB:</label>
                      <input type="date" name="DOB" max="<?php echo date("Y-m-d",strtotime("-16 year")) ?>" value="<?php if(isset($Setupdetails)) { if($Setupdetails['DOB']!='') { echo $Setupdetails['DOB']; }  }  ?>" class="form-control">
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                      ...
                      <input type="text"   id="btn" name="location" value="<?php if(isset($Setupdetails)) { if($Setupdetails['Location']!='') { echo $Setupdetails['Location']; } else { echo '31.1471° N, 75.3412° E'; }  }  ?>"  class="location form-control" placeholder="enter your location" required>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                      ...
                      <select name="IDCard" class="form-control" required  >
                        ...
                        <option <?php if(isset($Setupdetails)) { if($Setupdetails['IDCard']!='') { if($Setupdetails['IDCard']=='Voter Id Card') echo 'selected'; }  }  ?>  >Voter Id Card</option>
                         <option <?php if(isset($Setupdetails)) { if($Setupdetails['IDCard']!='') { if($Setupdetails['IDCard']=='PAN Card') echo 'selected'; }  }  ?>  >PAN Card</option>
                         <option <?php if(isset($Setupdetails)) { if($Setupdetails['IDCard']!='') { if($Setupdetails['IDCard']=='Driving Licence') echo 'selected'; }  }  ?>  >Driving Licence</option>
                         <option <?php if(isset($Setupdetails)) { if($Setupdetails['IDCard']!='') { if($Setupdetails['IDCard']=='Govt. issued id card') echo 'selected'; }  }  ?>  >Govt. issued id card</option> 
                        <option <?php if(isset($Setupdetails)) { if($Setupdetails['IDCard']!='') { if($Setupdetails['IDCard']=='Aadhar Card') echo 'selected'; }  }  ?>  >Aadhar Card</option>
                      </select>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      ...
                      <input type="text" name="ReferralID" value="<?php if(isset($Setupdetails)) { if($Setupdetails['ReferralID']!='') { echo $Setupdetails['ReferralID']; }  }  ?>"  class="form-control" placeholder="Enter Mobile No. of Referral By">
                    </div>
                  </div>
                </div>
              </div>
