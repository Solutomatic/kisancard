...
<!-- ##### Contact Area Start ##### -->
<section class="section-padding-100 contact_us_area" id="contact" data-jarallax="{&quot;speed&quot;: 0.5}" style="background-image: url('img/core-img/page-bg0.jpg'); background-size: cover; height:100vh" >
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="section-heading text-center"> 
          ...
          <h2 class="wow fadeInUp" data-wow-delay="0.3s">Start With Us</h2>
        </div>
      </div>
    </div>
        ...
        <div class="contact_form">
          <form action="#" method="post" id="main_contact_form" novalidate>
            <div class="row">
              ...
              <div class="col-12 mt-5 text-center wow fadeInUp" data-wow-delay="0.6s">
              <input class="btn dream-btn" type="button"  value="Send OTP" onclick="MobilesendOtp();" id="MobilesubmitOTPButton"> 
              </div>
            </div>
          </form>
        </div>
